...
if __name__ == "__main__":
    ...
    """
    training_file_path = '/ships19/grain/convective_init/pt_tensors/train_files/inputs/*'
    validation_file_path = '/ships19/grain/convective_init/pt_tensors/val_files/inputs/*'
    testing_file_path = '/ships19/grain/convective_init/pt_tensors/test_files/inputs/*'
    ...
    # testing_file_path = '/ships19/grain/convective_init/data_lists/testing/sublists/night_test_files.txt'
    ...
    # testing_files = testing_files[:1000]
    ...
    outdir = '/ships19/grain/convective_init/models/TC_CHs_02_05_13_15/' #name the model
    mkdir_p(outdir)
    #Specify path for starting training from a checkpoint or testing the model with a certain model checkpoint
    model_checkpoint_path = outdir + 'thundercast-ckpt-epoch=27-val_loss_epoch=0.4488.ckpt'#None #model path if using a model checkpoint
    ...
    params = {'ngpu':2, 'num_nodes':2, 'norm_vals':norm_vals, 'threshold':30.0, 'nepochs':30, 'nclass':2, 'vars':vars,
              ...
              'use_model_checkpoint':False, 'load_fcn':load_fcn, 'outdir':outdir, 'test_model':False, 'train_val_model':True,
